...
INPUT_FILES=(
    "input/stable-particle.txt"
    "input/attact-particle.txt"
    "input/repel-particle.txt"
    "input/block-particles.txt"
    "input/grid-particles.txt"
    "input/particles_test1.txt"
    "input/collision_cluster.txt"
    "input/repulsive_shell.txt"
)
